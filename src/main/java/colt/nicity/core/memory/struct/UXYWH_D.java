...
public class UXYWH_D {
     ...
     * @return
     */
    public static XYWH_D rect(double _fx, double _fy, double _tx,
        double _ty) {
        return new XYWH_D(
            Math.min(_fx, _tx),
            Math.min(_fy, _ty),
     ...
     * @return
     */
    public static boolean contains(double x, double y, double w, double h,
        double _x, double _y) {
     ...
     * @return
     */
    public static boolean intersects(double x, double y, double w,
     ...
     * @return
     */
    public static XYWH_D intersection(double x, double y, double w,
        double h, double _x, double _y, double _w, double _h) {
     ...
     * @return
     */
    public static XYWH_D union(double x, double y, double w, double h,
        double _x, double _y, double _w, double _h) {
